...
from app.ml.model_manager import CNN1DClassifier

def train_cnn(X_train, y_train, X_val, y_val):
    print("Training PyTorch 1D CNN on CPU...")
...
def main():
    ...
    model_path = os.path.join(models_dir, "cnn_1d.pth")
    torch.save(model.state_dict(), model_path)
    print(f"1D CNN model saved to {model_path}")
